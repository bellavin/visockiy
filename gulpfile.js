...
gulp.task(`server`, function () {
  ...
  gulp.watch(`source/img/sprite/*.svg`, gulp.series(`copysvg`, `sprite`, `html`, `refresh`));
  gulp.watch(`source/img/svg/*.svg`, gulp.series(`copysvg`, `html`, `refresh`));
  gulp.watch(`source/img/**/*.{png,jpg}`, gulp.series(`copypngjpg`, `html`, `refresh`));
  gulp.watch(`source/html/**/*.pug`, gulp.series(`html`, `refresh`));
